...
class ParticleSystem:
    def __init__(self, config: SnowConfig, GGUI = True):
        ...
        self.num_flat_boundary_particles = self.cfg.num_boundary_particles
        self.num_b_particles = 0 ##This is set in import_boundary_objects
    ...
    def import_boundary_objects(self):
        ...
        object_offsets = [] 
        total_num_b_particles = self.num_flat_boundary_particles
    ...
    def initialize_boundary_particle_block(self, len_x:float, len_y:float, len_z:float, origin:ti.template()):
        ...
        for i in range(self.num_flat_boundary_particles):
    ...
    def initialize_fields(self):
        ...
        if self.initialize_type == 'block':
            ...
            block_origin.from_numpy(self.cfg.block_origin.astype(np.float32) )
